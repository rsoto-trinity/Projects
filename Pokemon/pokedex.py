...
blastoise = Pokemon(
    ...
    moves=[
        ...
        Move("Bite", "Dark", 60, 1.0, "Physical", flinch_chance=0.3),
...
gyarados = Pokemon(
    ...
    moves=[
        ...
        Move("Ice Fang", "Ice", 65, 0.95, "Physical", status_effect="Frozen", status_chance=0.1, flinch_chance=0.3),
